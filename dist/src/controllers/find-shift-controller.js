...
exports.FindShiftController = void 0;
class FindShiftController {
    constructor(findShiftUserCase) {
        this.findShiftUserCase = findShiftUserCase;
    }
    handleFindByCollaboratorCodeAndMonth(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { collaboratorCode, year, month } = req.query;
            try {
                const shiftsForDay = yield this.findShiftUserCase.findByCollaboratorCodeAndMonth({
    ...
    handleFindByCollaboratorCodeAndDate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
